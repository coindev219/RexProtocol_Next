...
export default function FooterComponent() {
  ...
  return (
    <div>
      <footer className="p-4 bg-black sm:p-6 dark:bg-black w-full">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a
              href="https://www.reddit.com/r/REXProtocol/"
            ...
            <a
              href="https://twitter.com/REXProtocol"
              className="text-white hover:text-white dark:hover:text-white"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://github.com/CascadiaTech/RexProtocol"
              className="text-white hover:text-white dark:hover:text-white"
              target="_blank"
              rel="noopener noreferrer"
            >
